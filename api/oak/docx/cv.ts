...
async function CV() {
  ...
  class DocumentCreator {
        ...
        sections: [
          {
            children: [
              ...
              new docx.Paragraph("More references upon request"),
              new docx.Paragraph({
    ...
    public createHeading(text: string): docx.Paragraph {
      return new docx.Paragraph({
        text: text,
    ...
    public createSubHeading(text: string): docx.Paragraph {
      return new docx.Paragraph({
        text: text,
    ...
    public createInstitutionHeader(
      ...
      return new docx.Paragraph({
        ...
        children: [
          ...
          new docx.TextRun({
            children: [new docx.Tab(), dateText],
            bold: true,
          }),
        ],
      });
    ...
    public createRoleText(roleText: string): docx.Paragraph {
      return new docx.Paragraph({
        children: [
          new docx.TextRun({
            text: roleText,
    ...
    public createBullet(text: string): docx.Paragraph {
      return new docx.Paragraph({
        text: text,
        bullet: {
          level: 0,
    ...
    public createSkillList(skills: any[]): docx.Paragraph {
      return new docx.Paragraph({
        children: [
          new docx.TextRun(skills.map((skill) => skill.name).join(", ") + "."),
        ],
      });
    }

    // tslint:disable-next-line:no-any
    public createAchievementsList(achievements: any[]): docx.Paragraph[] {
    ...
    public createInterests(interests: string): docx.Paragraph {
      return new docx.Paragraph({
        children: [new docx.TextRun(interests)],
      });
    }
  ...
  await docx.Packer.toBuffer(doc).then((buffer) => {
    writeFileSync(
      join(Deno.cwd(), "api", "docx", "report", "report_cv.docx"),
      buffer
    );
  });
}
